...
// const filmId = filmCard.dataset.film;

filmCard.addEventListener('click', createModalMarkup);

const modalEl = document.querySelector('.modal-film');
...
function closeModal() {
  ...
  filmCard.removeEventListener('click', createModalMarkup);
}
